# RailsAdmin config file. Generated on November 09, 2011 03:00
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Socialwar', 'Admin']
  ...
  # config.excluded_models = [Gang, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Gang, User]
